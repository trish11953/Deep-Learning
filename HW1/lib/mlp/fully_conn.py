...
class TestFCGeLU(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        self.net = sequential(
            ########## TODO: ##########
            flatten(name="flatty"),
            fc(input_dim=15, output_dim=5, name="fully"),
            gelu(name="gelu")
            ########### END ###########
        )
...
class SmallFullyConnectedNetwork(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        self.net = sequential(
            ########## TODO: ##########
            fc(input_dim=4, output_dim=30, init_scale=0.02, name="fully_1"),
            gelu(name="gelu"),
            fc(input_dim=30, output_dim=7, init_scale=0.02, name="fully_2")
            ########### END ###########
        )
...
class TinyNet(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        ...
        self.net = sequential(
            ########## TODO: ##########
            flatten(name="flatty"),
            fc(input_dim=3072, output_dim=512, init_scale=0.02, name="fully_1"),
            gelu(name="gelu"),
            fc(input_dim=512, output_dim=20, init_scale=0.02, name="fully_2")
            ########### END ###########
        )
